    ...
    <header>
      ...
      <nav class="nav-collapse">
        <ul>
          ...
          <li class="menu-item"><a href="diu-result-public.php" data-scroll> DIU Result</a></li>
    ...
    if (isset($_POST['student_login_submit']))
     {
        if (empty($_POST['sid_']) || empty($_POST['pass_']))
        ...
        else
          {
              ...
              $query_result = mysqli_query($connection, "SELECT * FROM `student_diu` WHERE `student_id` = '$sid'");
              ...
              if (mysqli_num_rows($query_result) == 1)
                {
                  ...
                  if(verify($password ,$encrypted_hashedPassword)){
                    ...
                    //$error = "*** Log ok";
                     ...
                     ?> <script>swal("Opss...","Student id or Password is invalid", "error");</script> <?php
                  }
                  //echo "login xx";
                  //$error = "*** Log ok";
